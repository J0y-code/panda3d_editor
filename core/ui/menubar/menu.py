...
class MenuBar(ActionBar):
    def __init__(self, editor_ui=None, **kwargs):
        ...
        # --- Groupe "Lumières" ---
        self.lights_group = ActionGroup(text='LIights & effects')
        self.action_view.add_widget(self.lights_group)

        # Boutons pour ajouter des lights
        self.add_sun_btn = ActionButton(text='Add Sun (directional light)')
        self.add_light_to_model_btn = ActionButton(text='Add a light to Model')
