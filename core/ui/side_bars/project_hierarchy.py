...
class ProjectHierarchySidebar(BoxLayout):
    ...
    def __init__(self, panda_app=None, ui_app=None, project_root: str = ".", **kwargs):
        ...
        self.tree_container = BoxLayout(orientation='vertical', padding=2, spacing=2)
        with self.tree_container.canvas.before:
            Color(0.1, 0.1, 0.1, 1)  # couleur du rectangle
            self.tree_container.rect = Rectangle(pos=self.tree_container.pos, size=self.tree_container.size)
        self.tree_container.bind(pos=self.update_rect_container, size=self.update_rect_container)
        ...
        self.tree_container.add_widget(self.scroll)
        self.add_widget(self.tree_container)
        self.refresh()
    ...
    def refresh(self):
        ...
        if hasattr(self, 'scroll') and hasattr(self, 'tree'):
            ...
            self.tree_container.remove_widget(self.scroll)
